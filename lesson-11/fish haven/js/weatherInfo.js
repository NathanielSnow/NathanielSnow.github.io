const apiURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&APPID=5e43dd05ae8a3a0b6ab722a0f92e51ff&units=imperial';
...
fetch(fetchURL)
  ...
  .then((jsObject) => {
    ...
    for(i = 0; i < events.length; i++){
        ...
        document.querySelector('div#events').appendChild(eventLine);
    }
